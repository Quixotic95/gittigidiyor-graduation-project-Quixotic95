...
import com.gittigidiyor.quixotic95.loanapp.mapper.ExceptionLogMapper;
import com.gittigidiyor.quixotic95.loanapp.repository.ExceptionLogRepository;
...
public class GlobalExceptionHandler {
    ...
    */
    ...
    @ExceptionHandler(LoanApplicationAlreadyExistsWithMonthlyIncomeForCustomerException.class)
    public ResponseEntity<?> handleLoanApplicationAlreadyExistsWithMonthlyIncomeForCustomerException(LoanApplicationAlreadyExistsWithMonthlyIncomeForCustomerException e, HttpServletRequest req) {
        ExceptionLog exceptionLog = new ExceptionLog(e.getMessage(), HttpStatus.EXPECTATION_FAILED, req.getRequestURI(), req.getMethod());
        exceptionLogRepository.save(exceptionLog);

        return ResponseEntity.status(HttpStatus.EXPECTATION_FAILED).body(ExceptionLogMapper.INSTANCE.toExceptionLogDto(exceptionLog));
    }
